      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="space-y-2 text-sm mb-4">
          <div className="flex items-start text-gray-700">
            <svg className="w-4 h-4 mr-2 mt-0.5 shrink-0 text-comedy-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            <span><strong>{show.date}</strong><span className="mx-1">·</span>{show.time}{show.doors && <span className="text-gray-500 ml-1">· Doors {show.doors}</span>}</span>
          </div>
