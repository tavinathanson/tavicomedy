...
export default function CheckoutModal({ open, onClose, initialStep, bypass, bypassMax }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl w-full max-w-lg max-h-[90vh] overflow-y-auto mx-4 shadow-2xl">
        ...
        {step === 'soldout' ? (
          ...
          <div className="p-8 text-center">
            {bypass && (
              <p className="text-xs text-gray-500 bg-yellow-50 border border-yellow-200 rounded-md px-3 py-2 mb-4">
